...
<div class="page-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="row" style="margin-left: 15px">
            <form style="width: 500px" action="{{route('admins.store')}}" method="POST">
                ...
                <div class="form-group">
                    <label style="color: white">privileges</label>
                    <input class="form-control" type="text" name="privileges" required="required"/>
                </div>
                ...
                {{--<div class="form-group">--}}
                {{--<label style="color: white" class="control-label">Manager</label>--}}
