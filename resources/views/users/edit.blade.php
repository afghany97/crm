...
<div class="page-wrapper">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="row" style="margin-left: 15px">
            <form style="width: 500px" action="{{route('users.update',$user)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="admin_id">
                        ...
                        @foreach($admins as $admin)
                            ...
                            <option value="{{$admin->id}}" {{$user->admin->id == $admin->id ? "selected" : ""}}> {{ $admin->name }}</option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="type" required="required" value="{{$user->type}}"/>
                </div>

                <div class="form-group">
                    <label style="color: white">name</label>
                    <input class="form-control" type="text" name="name" required="required" value="{{$user->name}}"/>
                </div>

                <div class="form-group">
                    <label style="color: white">address</label>
                    <input class="form-control" type="text" name="address" required="required" value="{{$user->address}}"/>
                </div>

                <div class="form-group">
                    <label style="color: white">email</label>
                    <input class="form-control" type="email" name="email" required="required" value="{{$user->email}}"/>
                </div>
                ...
                <div class="form-group">
                    <input class="form-control" type="submit" value="udpate"/>
                </div>
            </form>
        </div>
    </div>
